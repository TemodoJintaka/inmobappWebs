...
export const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    updateMetaTags({
      title: 'MLS Properties - Encuentra tu propiedad ideal',
      ...
      keywords: 'propiedades, inmuebles, bienes raíces, venta, alquiler, casas, apartamentos, MLS',
      ogTitle: 'MLS Properties - Tu hogar ideal te espera',
      ogDescription: 'Explora miles de propiedades con nuestro sistema MLS. Encuentra, compara y elige tu próximo hogar.',
      ogType: 'website',
      canonical: '/',
    });
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <button
                ...
                className="px-6 py-3 text-lg font-semibold rounded-lg bg-white text-blue-600 hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Ver Todas las Propiedades
              </button>
              <button
                onClick={() => navigate('/propiedades?type_negotiation=1')}
                className="px-6 py-3 text-lg font-semibold rounded-lg bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 transition-all duration-200"
              >
