        ...
        <div className="space-y-2">
          {franchise.phone && (
            <div className="flex items-center text-gray-700">
              ...
              <a href={`tel:${franchise.phone}`} className="hover:text-[#7367F0]">
                {franchise.phone}
              </a>
            </div>
          )}
          {franchise.email && (
            <div className="flex items-center text-gray-700">
              ...
              <a href={`mailto:${franchise.email}`} className="hover:text-[#7367F0]">
                {franchise.email}
              </a>
            </div>
          )}
      ...
      <div className="space-y-3 mb-6">
        {user.phone && (
          <div className="flex items-center text-gray-700">
            ...
            <a href={`tel:${user.phone}`} className="hover:text-[#7367F0]">
              {user.phone}
            </a>
          </div>
        )}
        {user.email && (
          <div className="flex items-center text-gray-700">
            ...
            <a href={`mailto:${user.email}`} className="hover:text-[#7367F0]">
              {user.email}
            </a>
          </div>
        )}
